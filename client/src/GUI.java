...
class GUIpanel extends JPanel implements MouseListener, TreeModelListener {
    ...
    GUIpanel(){
        ...
        this.add(exit, c);
        c.fill = GridBagConstraints.BOTH;c.gridx = 0;c.gridy = 1;c.gridheight = 10;c.gridwidth = 2;
        this.add(listScroll, c);
        c.fill = GridBagConstraints.BOTH;c.gridx = 2;c.gridy = 1;c.gridwidth = 1;
        this.add(download, c);
        c.fill = GridBagConstraints.BOTH;c.gridx = 0;c.gridy = 12;
        c.anchor = GridBagConstraints.PAGE_END; c.weighty = 5;c.weightx = 5;
